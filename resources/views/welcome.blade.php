...
<head>
    ...
    <title>Welcome | CMS TMI</title>
    <link href="https://fonts.googleapis.com/css?family=Heebo:400,400i,500,700|Titillium+Web:600" rel="stylesheet">
    <link rel="stylesheet" href="Welcome/dist/css/style.css">
    <script src="https://unpkg.com/scrollreveal@4.0.0/Welcome/dist/scrollreveal.min.js"></script>
</head>
<body class="is-boxed">
            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0 is-revealing">CMS Toko Mandiri Indogrosir</h1>
	                        <p class="hero-paragraph is-revealing">Sistem Layanan  Untuk Mengelola Konten / Tampilan Dashboard Toko Mandiri Indogrosir (TMI).</p>
							<div class="hero-form field field-grouped is-revealing">

	                            <div class="control">
                                    <a class="button button-primary button-wide-mobile" href="{{url('/login')}}">Akses Menu Login</a>
	                            </div>
	                        </div>
						</div>
    ...
    <script src="Welcome/dist/js/main.min.js"></script>
</body>
</html>
